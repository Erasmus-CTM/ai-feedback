...
[combined authoring examples](https://github.com/Erasmus-CTM/ctm-assessment/blob/feature/scoped-policies/docs/reference.md#reuse-one-block-across-different-integrations).
